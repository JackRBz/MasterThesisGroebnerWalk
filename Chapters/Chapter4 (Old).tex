...
%-------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Tasks todo
%%Fix ordering symbols (order/preorder stuff), < for order, \prec for PREorder 
%%Explain difference between order and preorder? => Explain our reasoning for changing ordering symbol notation
%%Prove S_{g} \subseteq supp(in_{"hard"} (g)) \subseteq supp(g) (see written diagrams, for optimising part 3 since facet preorder is computationally expensive, and explain this)
%-------------------------------------------------------------------
